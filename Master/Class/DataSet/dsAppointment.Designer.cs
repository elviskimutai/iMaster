...
namespace Master.Class.DataSet.dsAppointmentTableAdapters {
    ...
    public partial class ResourcesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Resources] WHERE (([Id] = @Original_Id) AND ((@IsNull_IdSort = 1 AND [IdSort] IS NULL) OR ([IdSort] = @Original_IdSort)) AND ((@IsNull_ParentId = 1 AND [ParentId] IS NULL) OR ([ParentId] = @Original_ParentId)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Resources] ([IdSort], [ParentId], [Description], [Color], [Image], [CustomField1]) VALUES (@IdSort, @ParentId, @Description, @Color, @Image, @CustomField1);
SELECT Id, IdSort, ParentId, Description, Color, Image, CustomField1 FROM Resources WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Resources] SET [IdSort] = @IdSort, [ParentId] = @ParentId, [Description] = @Description, [Color] = @Color, [Image] = @Image, [CustomField1] = @CustomField1 WHERE (([Id] = @Original_Id) AND ((@IsNull_IdSort = 1 AND [IdSort] IS NULL) OR ([IdSort] = @Original_IdSort)) AND ((@IsNull_ParentId = 1 AND [ParentId] IS NULL) OR ([ParentId] = @Original_ParentId)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)));
SELECT Id, IdSort, ParentId, Description, Color, Image, CustomField1 FROM Resources WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, IdSort, ParentId, Description, Color, Image, CustomField1\r\nFROM" +
                "            Resources";
        ...
        public virtual int Fill(dsAppointment.ResourcesDataTable dataTable) {
        ...
        public virtual dsAppointment.ResourcesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsAppointment.ResourcesDataTable dataTable = new dsAppointment.ResourcesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsAppointment.ResourcesDataTable dataTable) {
...
SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, CustomField1 FROM Appointments WHERE (UniqueID = @UniqueID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(dsAppointment.AppointmentsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual dsAppointment.AppointmentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsAppointment.AppointmentsDataTable dataTable = new dsAppointment.AppointmentsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsAppointment.AppointmentsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class TaskDependenciesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [TaskDependencies] WHERE (([Id] = @Original_Id) AND ((@IsNull_ParentId = 1 AND [ParentId] IS NULL) OR ([ParentId] = @Original_ParentId)) AND ((@IsNull_DependentId = 1 AND [DependentId] IS NULL) OR ([DependentId] = @Original_DependentId)) AND ([Type] = @Original_Type))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_ParentId", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ParentId", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ParentId", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ParentId", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [TaskDependencies] ([ParentId], [DependentId], [Type]) VALUES (@Paren" +
                "tId, @DependentId, @Type);\r\nSELECT Id, ParentId, DependentId, Type FROM TaskDepe" +
...
SELECT Id, ParentId, DependentId, Type FROM TaskDependencies WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        Id, ParentId, DependentId, Type\r\nFROM            TaskDependencies";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(dsAppointment.TaskDependenciesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual dsAppointment.TaskDependenciesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsAppointment.TaskDependenciesDataTable dataTable = new dsAppointment.TaskDependenciesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsAppointment.TaskDependenciesDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
